...
# ========================= Dataset Configs ==========================
parser.add_argument('--annotation', type=str, default=r'data/mimic_annotation.json', help="mimic annotation")
...
parser.add_argument('--delta_file', type=str, default='/home/zhanyu_wang/code/LLamaR2Gen/save/mimic/swinllama_v2_v2/checkpoints/checkpoint_epoch10_step737897_bleu0.081338_cider0.065194.pth')
...
parser.add_argument('--llama_model', default='vicuna_weights', type=str)
parser.add_argument('--prompt_template', default='###Human: {} ###Radiologist: ', type=str)
parser.add_argument('--max_txt_len', default=150, type=int)
...
parser.add_argument('--report_min_length', type=int, default=120)
parser.add_argument('--report_max_length', type=int, default=150)
...
parser.add_argument('--max_epochs', type=int, default=20, help='number of total epoches to run')
